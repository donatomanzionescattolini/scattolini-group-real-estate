...
This PR implements a complete authentication system and multi-step graphical editor for managing Desarrollo and Area
objects in the Scattolini Group website. All requirements from the problem statement have been successfully implemented.
