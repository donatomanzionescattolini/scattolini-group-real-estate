...
export default function Equipo() {
    return (
        <section className="m-5 p-5 mt-0 pt-0 container-sm mx-auto justify-content-center">
            ...
            <div>
                {innerWidth > 650 &&
                    <iframe width="320" height="1000" src="https://www.instagram.com/scattolinigroup/embed/"
                            frameBorder={1} autoFocus></iframe>
                }
                {innerWidth < 650 &&
                    <iframe width="320" height="400" src="https://www.instagram.com/scattolinigroup/embed/"
                            frameBorder={1} autoFocus></iframe>
