    ...
    return (
        <>
            <div className="city-banner p-0 ">
                ...
                >
                    <h2 className="text-center text-white">CoconutGrove</h2>
                </div>
                <div className="container-fluid text-center">
                    <h2 className="text-center mt-5">El Distrito Financiero de Miami</h2>
                ...
                <div className="row d-flex align-items-center justify-content-around">
                    <div className="col-xs-12 col-sm-12 col-md-8 col-lg-8 ps-5 pe-5 pb-2">
                        <p className="text-muted ">
                            <small>
                                CoconutGrove es el distrito financiero de Miami y de todo el sur
                                de Florida. Con sus rascacielos, sus restaurantes y tiendas de
                                lujo, y su ambiente cosmopolita, CoconutGrove es el lugar ideal
                                para aquellos que buscan una experiencia urbana sofisticada. En
                                CoconutGrove, encontrarás una amplia variedad de opciones de
                                propiedades, desde lujosos condominios con vistas impresionantes
                                hasta modernos lofts y apartamentos.
                                <br/>
                                <br/>
                                CoconutGrove es el lugar donde el lujo y la sofisticación se
                                encuentran en Miami. Con el impresionante CoconutGrove City
                                Centre, un complejo de uso mixto que ofrece una experiencia de
                                compras, entretenimiento y gastronomía de primer nivel , podrás
                                disfrutar de una vida urbana cosmopolita en el corazón de la
                                ciudad.
                            </small>
                        </p>
                    </div>
                    <div className="col-xs-12 col-sm-12 col-md-4 col-lg-4 ">
                        <picture className="">
                            <img
                                src="https://img1.wsimg.com/isteam/ip/786b303a-2103-4baa-8820-66fa202ca80b/brickellcitycenter2.jpg"
                                className="w-100 img-responsive align-self-center justify-self-center m-auto"
                                alt="CoconutGrove City Center"
                            />
                        </picture>
                    </div>
                </div>
            ...
            <div className="city-firstcarousel">
                ...
                <Image
                    src="https://previews.dropbox.com/p/thumb/AB_usiShPJbv88ELZMUEjnC89ezsKXS4XKDPmWp7AGGO0VdpDzWJO6_A0Qt7-U6wJpP6PSwm5-dqG0C80FVDz4P7LqiYUtD4-CZHVmyzXYODV1zBTbvaPytYDsdsIjpneUd9oHC0BJ3tSIHtRS2ZhadrQh19OW-2A9mN9DPUN-TIWYODZl3_BY4i-EAScyjmQQsOMXdZz80Rq7ZSAKjtgg-_iFkNwImhRuQspM4jSQcWRjGmhPy0DQQAb14MzJl9vKM6NyfJo_24nMvKqjbSyUV-MeotCNiYSxdFLQIYBoLGQYO6Sl3aMcgz9bYF5lYd-PJqvX4Z-CMZ7Qe81in6B8px/p.jpeg"
                    alt="Lofty"
                />
            </div>
