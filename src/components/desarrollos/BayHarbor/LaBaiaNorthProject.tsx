...
export default function LaBaiaNorthProject(){
    ...
    return (<ProjectTemplate banner properties={<PropiedadesBayHarbor/>} nombre={'la-baia'} caracteristicas={{edificio:<dl><dt>Ubicación</dt><dd>9481 East Bay Harbor Dr, Islas de Bay Harbor, FL 33154, Estados Unidos
        </dd><dt>Número de Pisos</dt><dd>8</dd><dt>Número de Residencias</dt><dd>57</dd></dl>, residencias:<><ul>
            <li>Techos de 9' en residencias</li>
            <li>Techos de 10' en Penthouses Superiores</li>
            <li>Terrazas privadas con vistas despejadas de la Bahía de Biscayne, el Océano Atlántico, Bal Harbour, Miami Beach y el centro de Miami</li>
            ...
            <li>Estudio/oficina en casa con un baño completo para descansar y un cómodo espacio para "trabajar desde casa"</li>
            <li>Lavandería en la residencia con juego de lavadora y secadora Miele® de tamaño completo y de bajo consumo</li>
            <li>Espacio de doble armario de tamaño generoso, que incluye vestidores en las habitaciones principales</li>
            ...
            <li>Gabinetes europeos personalizados y despensa de cocina • Paquete de electrodomésticos Miele® que incluye: placa de cocción eléctrica, horno de pared, lavavajillas, refrigerador y microondas</li>
            ...
            <li>20,000 pies cuadrados de comodidades estilo centro turístico; incluyendo más de 8,500 pies cuadrados de exuberantes jardines tropicales y espacios verdes abiertos en todas partes</li>
            <li>Terraza de servicios en la azotea de 10,000 pies cuadrados con área dedicada para niños y área para adultos</li>
            ...
            <li>Spa tropical climatizado para adultos en la azotea con vistas a la Bahía de Biscayne y al Océano Atlántico</li>
            <li>Salas de estar</li>
            <li>Cocina de verano y comedor al aire libre en la azotea con espectaculares vistas a la bahía</li>
            <li>Rooftop Sunset Lounge con acogedores asientos, hoguera e impresionantes vistas de la puesta de sol</li>
            <li>Rincones privados para sentarse y nidos colgantes para una relajación aislada</li>
            <li>Oficinas comerciales privadas</li>
            <li>Sala Club para Residentes con vista al agua con Salón, sala de cine y bar privado para entretener</li>
