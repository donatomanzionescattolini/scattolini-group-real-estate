...
export function TheEditionResidences() {
    return (
        <ProjectTemplate
            banner
            properties={<PropiedadesEdgewater/>}
            nombre={"edition-residences"}
            caracteristicas={{
                edificio: (
                    <pre>
            ...
            introduccion={[
                "Edition Residences, Miami EdgewaterComponent es una celebración del mejor estilo de vida moderno de Miami, uno que solo Edition puede ofrecer.",
            ...
            titulo={"The Edition Residences"}
            subtitulo={"Un desarrollo exclusivo en Miami Beach"}
            numberOfImages={29}
        />
    );
}
