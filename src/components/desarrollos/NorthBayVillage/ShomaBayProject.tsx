...
import PropiedadesNorthBayVillage from "./PropiedadesNorthBayVillage";

export default function ShomaBayProject() {
    return (
        <ProjectTemplate
            properties={<PropiedadesNorthBayVillage/>}
            nombre={"shoma-bay"}
            direccion="1850 John F Kennedy Causeway, North Bay Village, FL
      33141"
            caracteristicas={{
                edificio: (
                    <ul>
