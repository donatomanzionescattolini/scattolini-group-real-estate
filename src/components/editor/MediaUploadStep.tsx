...
export default function MediaUploadStep({
  ...
  const handleBannerUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setError("");
    setUploadProgress(
      t("pages.editor.media.uploadingBanner", "Uploading banner...") as string,
    );
    ...
    if (result.success) {
      ...
      setError(result.error || String(t("pages.editor.media.uploadFailed")));
    }
  ...
  const handleThumbnailUpload = async (
    ...
    setUploadProgress(
      t(
        "pages.editor.media.uploadingThumbnail",
        "Uploading area thumbnail...",
      ) as string,
    );
  ...
  const handleVideoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setError("");
    setUploadProgress(
      t("pages.editor.media.uploadingVideo", "Uploading video...") as string,
    );
  ...
  const handleGalleryUpload = async (
    ...
    for (let i = 0; i < files.length; i++) {
      ...
      const uploadTemplate = String(
        t("pages.editor.media.uploadingImageTemplate"),
      );
      setUploadProgress(
        uploadTemplate
    ...
    if (uploadedCount > 0) {
      ...
      setSuccess(
        `${uploadedCount} ${t("pages.editor.media.imagesUploaded", "images uploaded successfully")}`,
      );
    }
  ...
  const handleDeleteFile = async (file: MediaFile) => {
    if (
      !confirm(
        t(
          "pages.editor.media.confirmDelete",
    ...
    if (success) {
      ...
      setError(
        t("pages.editor.media.deleteError", "Error deleting file") as string,
      );
    }
  };

  const getMediaByType = (type: MediaFile["type"]) =>
    currentMedia.filter((f) => f.type === type);
  ...
  if (!projectName) {
    return (
      <div className="alert alert-warning">
        {t(
          "pages.editor.media.noProjectName",
  ...
  return (
    <div className="media-upload-step">
      ...
      <p className="text-muted small mb-4">
        {t(
          "pages.editor.wizard.desarrollo.mediaInfo",
          "Upload files to S3. They will be accessible at:",
        )}
        <br />
        <code>{baseUrl}/</code>
      </p>
      ...
      <Card className="mb-3">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <Badge
              bg={getMediaByType("banner").length > 0 ? "success" : "secondary"}
            >
              {getMediaByType("banner").length > 0
                ? "✓"
                : t("pages.editor.media.missing", "Missing")}
            </Badge>
          </div>
          ...
          {getMediaByType("banner").map((file) => (
            ...
            >
              <img
                src={file.url}
                alt={String(t("pages.editor.media.bannerPreviewAlt"))}
      ...
      <Card className="mb-3">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <Badge
              bg={
                getMediaByType("thumbnail").length > 0 ? "success" : "secondary"
              }
            >
              {getMediaByType("thumbnail").length > 0
                ? "✓"
                : t("pages.editor.media.missing", "Missing")}
            </Badge>
          </div>
          <p className="small text-muted mb-2">
            {t(
              "pages.editor.media.thumbnailInfo",
              "This image appears in area listings.",
            )}
            <br />
          ...
          {getMediaByType("thumbnail").map((file) => (
            ...
            >
              <img
                src={file.url}
                alt={String(t("pages.editor.media.thumbnailPreviewAlt"))}
      ...
      <Card className="mb-3">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <Badge
              bg={getMediaByType("video").length > 0 ? "success" : "secondary"}
            >
      ...
      <Card className="mb-3">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <Badge
              bg={getMediaByType("pdf").length >= 3 ? "success" : "warning"}
            >
          ...
          {getMediaByType("pdf").map((file) => (
            ...
            >
              ...
              <a
                ...
                title={String(t("pages.editor.media.viewPdf"))}
              >
                <i className="fas fa-eye"></i>
                <span className="visually-hidden">
                  {t("pages.editor.media.viewPdf")}
                </span>
              </a>
              <Button
                size="sm"
      ...
      <Card className="mb-3">
        <Card.Body>
          <div className="d-flex justify-content-between align-items-center mb-2">
            ...
            <Badge
              bg={
                getMediaByType("gallery").length > 0 ? "success" : "secondary"
              }
            >
              {getMediaByType("gallery").length}{" "}
              {t("pages.editor.media.images", "images")}
            </Badge>
          </div>
          ...
          <div className="d-flex flex-wrap gap-2 mb-3">
            {getMediaByType("gallery").map((file) => (
              <div
                key={file.key}
                className="position-relative gallery-thumbnail-container"
              >
                <img
                  src={file.url}
                  alt={file.name}
                ...
                <button
                  ...
                  title={String(t("pages.editor.media.deleteImage"))}
                  aria-label={String(t("pages.editor.media.deleteImage"))}
                  onClick={() => handleDeleteFile(file)}
                >
                  ×
                </button>
          ...
          <div className="mt-2">
            <input
              ...
              disabled={uploading}
              title={String(t("pages.editor.media.uploadGalleryTitle"))}
            />
            <div className="form-text">
              {t(
