        ...
        <div className="media-upload-step">
            {error && (
                <div className="alert alert-danger alert-dismissible mb-3">
                    {error}
                    <button type="button" className="btn-close" title="Close" aria-label="Close"
            ...
            <Card className="mb-3">
                <Card.Body>
                    ...
                    <div className="mt-2">
                        ...
                        />
                        <div
                            className="form-text">{t('pages.editor.media.bannerHelp', 'File must be named "banner.jpg"')}</div>
                    </div>
                </Card.Body>
            </Card>
            ...
            <Card className="mb-3">
                <Card.Body>
                    ...
                    <div className="mt-2">
                        ...
                        />
                        <div
                            className="form-text">{t('pages.editor.media.thumbnailHelp', 'Upload a .webp image for area listings')}</div>
                    </div>
                </Card.Body>
            </Card>
            ...
            <Card className="mb-3">
                <Card.Body>
                    ...
                    <div className="mt-2">
                        ...
                        />
                        <div
                            className="form-text">{t('pages.editor.media.videoHelp', 'File must be named "video.mp4"')}</div>
                    </div>
                </Card.Body>
            </Card>
                    ...
                    {getMediaByType('pdf').map(file => (
                        <div key={file.key} className="d-flex align-items-center mb-2 p-2 bg-light rounded">
                            ...
                            <a href={file.url} target="_blank" rel="noopener noreferrer"
                               className="btn btn-sm btn-secondary me-1" title="View PDF">
            ...
            {loading && (
                <div className="text-center py-3">
                    <Spinner animation="border"
                             size="sm"/> {t('pages.editor.media.loadingMedia', 'Loading current media...')}
                </div>
            )}
        </div>
    );
