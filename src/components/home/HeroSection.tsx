  ...
  return (
    <section className="relative isolate flex min-h-[calc(100vh-6rem)] items-end overflow-hidden bg-section-bg">
      ...
      <video
        ...
        playsInline
      />
      <div className="absolute inset-0 bg-[linear-gradient(110deg,rgba(237,227,214,0.9),rgba(237,227,214,0.68),rgba(237,227,214,0.42))]" />
      <div className="site-container relative z-10 py-20 sm:py-28">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-6 text-5xl leading-tight text-navy sm:text-6xl lg:text-7xl">
            {t('hero.heading').split('\n').map((line, i) => (
              <span key={i}>{line}{i === 0 ? <br /> : null}</span>
            ))}
          </h1>
          <p className="mt-6 max-w-2xl text-lg leading-8 text-[rgba(27,52,51,0.84)]">
            {t('hero.description')}
          </p>
