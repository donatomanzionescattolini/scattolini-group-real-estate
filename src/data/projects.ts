...
const projectSeeds: ProjectSeed[] = [
  { id: 'baccarat-residences', name: 'Baccarat Residences', areaId: 'brickell', areaName: 'Brickell', tagline: 'French artistry on the Miami River', priceFrom: '$2.4M', type: 'branded', status: 'under-construction', featured: true, imageIndex: 0 },
  ...
  { id: 'domus-brickell', name: 'Domus', areaId: 'brickell', areaName: 'Brickell', tagline: 'Short-stay ready luxury with a cosmopolitan rhythm', priceFrom: '$720K', type: 'residential', status: 'completed', imageIndex: 2 },
  ...
  { id: 'lofty-brickell', name: 'Lofty Brickell', areaId: 'brickell', areaName: 'Brickell', tagline: 'Design-forward residences created for ownership and flexibility', priceFrom: '$860K', type: 'luxury', status: 'pre-construction', imageIndex: 4 },
  { id: 'ora-by-casa-tua', name: 'ORA by Casa Tua', areaId: 'brickell', areaName: 'Brickell', tagline: 'Italian hospitality meets Brickell sophistication', priceFrom: '$1.2M', type: 'branded', status: 'pre-construction', imageIndex: 5 },
  { id: 'cipriani-residences-miami', name: 'Cipriani Residences Miami', areaId: 'brickell', areaName: 'Brickell', tagline: 'Legendary service with a waterfront address', priceFrom: '$1.8M', type: 'branded', status: 'under-construction', featured: true, imageIndex: 6 },
  ...
  { id: '888-brickell-dolce-gabbana', name: '888 Brickell by Dolce & Gabbana', areaId: 'brickell', areaName: 'Brickell', tagline: 'Italian fashion house glamour in the sky', priceFrom: '$2.6M', type: 'branded', status: 'pre-construction', featured: true, imageIndex: 9 },
  ...
  { id: 'parkside-brickell', name: 'Parkside', areaId: 'brickell', areaName: 'Brickell', tagline: 'Family-oriented luxury near Brickell\'s green edge', priceFrom: '$890K', type: 'residential', status: 'pre-construction', imageIndex: 2 },
  ...
  { id: 'ella-miami-beach', name: 'Ella Miami Beach', areaId: 'miami-beach', areaName: 'Miami Beach', tagline: 'A boutique beach retreat with vintage glamour', priceFrom: '$790K', type: 'luxury', status: 'under-construction', imageIndex: 6 },
  ...
  { id: 'nexo-residences', name: 'Nexo Residences', areaId: 'miami-beach', areaName: 'Miami Beach', tagline: 'Modern ownership with smart flexibility', priceFrom: '$690K', type: 'residential', status: 'under-construction', imageIndex: 3 },
  { id: 'one-park-tower', name: 'One Park Tower', areaId: 'miami-beach', areaName: 'Miami Beach', tagline: 'Grand-scale living moments from the shoreline', priceFrom: '$1.35M', type: 'luxury', status: 'pre-construction', featured: true, imageIndex: 1 },
  ...
  { id: 'palma-miami-beach', name: 'Palma Miami Beach', areaId: 'miami-beach', areaName: 'Miami Beach', tagline: 'Quiet waterfront elegance in North Beach', priceFrom: '$1.05M', type: 'luxury', status: 'pre-construction', imageIndex: 8 },
  ...
  { id: 'edition-residences-miami', name: 'Edition Residences Miami', areaId: 'edgewater', areaName: 'Edgewater', tagline: 'Refined waterfront living from an iconic hospitality brand', priceFrom: '$2.7M', type: 'branded', status: 'under-construction', imageIndex: 2 },
  { id: 'the-villa-edgewater', name: 'The Villa', areaId: 'edgewater', areaName: 'Edgewater', tagline: 'Bayfront privacy with contemporary architectural clarity', priceFrom: '$1.25M', type: 'luxury', status: 'pre-construction', imageIndex: 3 },
  { id: 'vida-residences', name: 'Vida Residences', areaId: 'edgewater', areaName: 'Edgewater', tagline: 'Well-composed residences for elevated daily living', priceFrom: '$920K', type: 'residential', status: 'pre-construction', imageIndex: 5 },
  ...
  { id: 'aston-martin-residences', name: 'Aston Martin Residences', areaId: 'downtown', areaName: 'Downtown Miami', tagline: 'Automotive-inspired design at the edge of Biscayne Bay', priceFrom: '$2.8M', type: 'branded', status: 'completed', imageIndex: 1 },
  { id: 'casa-bella-residences', name: 'Casa Bella Residences', areaId: 'downtown', areaName: 'Downtown Miami', tagline: 'Italian refinement overlooking the city and bay', priceFrom: '$1.45M', type: 'luxury', status: 'under-construction', imageIndex: 6 },
  { id: 'the-elser-hotel-residences', name: 'The Elser Hotel & Residences', areaId: 'downtown', areaName: 'Downtown Miami', tagline: 'A hospitality-led address in the heart of the action', priceFrom: '$820K', type: 'branded', status: 'completed', imageIndex: 7 },
  ...
  { id: 'waldorf-astoria-hotel-residences', name: 'Waldorf Astoria Hotel & Residences', areaId: 'downtown', areaName: 'Downtown Miami', tagline: 'A stacked-glass icon with world-class hospitality', priceFrom: '$1.9M', type: 'branded', status: 'under-construction', featured: true, imageIndex: 0 },
  { id: 'jem-private-residences', name: 'JEM Private Residences', areaId: 'downtown', areaName: 'Downtown Miami', tagline: 'Private ownership elevated by cultural connectivity', priceFrom: '$970K', type: 'luxury', status: 'pre-construction', imageIndex: 4 },
  ...
  { id: 'la-baia-north', name: 'La Baia North', areaId: 'bay-harbor', areaName: 'Bay Harbor Islands', tagline: 'Boutique waterfront living with island intimacy', priceFrom: '$1.2M', type: 'luxury', status: 'under-construction', imageIndex: 6 },
  { id: 'la-mare', name: 'La Maré', areaId: 'bay-harbor', areaName: 'Bay Harbor Islands', tagline: 'Contemporary calm beside calm waters and marinas', priceFrom: '$1.45M', type: 'luxury', status: 'completed', imageIndex: 9 },
  { id: 'origin-residences', name: 'Origin Residences', areaId: 'bay-harbor', areaName: 'Bay Harbor Islands', tagline: 'A clean-lined address for modern island living', priceFrom: '$980K', type: 'residential', status: 'pre-construction', imageIndex: 3 },
  { id: 'the-well-bay-harbor', name: 'The Well Bay Harbor', areaId: 'bay-harbor', areaName: 'Bay Harbor Islands', tagline: 'Wellness-centric ownership in a serene enclave', priceFrom: '$1.55M', type: 'luxury', status: 'under-construction', imageIndex: 5 },
  { id: 'vita-coconut-grove', name: 'Vita Coconut Grove', areaId: 'coconut-grove', areaName: 'Coconut Grove', tagline: 'Ultra-private bayfront residences for the discerning few', priceFrom: '$5.8M', type: 'luxury', status: 'under-construction', imageIndex: 0 },
  ...
  { id: 'cora-at-merrick-park', name: 'Cora at Merrick Park', areaId: 'coral-gables', areaName: 'Coral Gables', tagline: 'Walkable luxury beside one of Miami\'s premier retail destinations', priceFrom: '$990K', type: 'luxury', status: 'under-construction', imageIndex: 4 },
  { id: 'cassia-coral-gables', name: 'Cassia Coral Gables', areaId: 'coral-gables', areaName: 'Coral Gables', tagline: 'Classic elegance reinterpreted for modern ownership', priceFrom: '$1.1M', type: 'luxury', status: 'completed', imageIndex: 10 },
  ...
  { id: 'st-regis-sunny-isles', name: 'St. Regis Sunny Isles', areaId: 'sunny-isles', areaName: 'Sunny Isles Beach', tagline: 'Tailored service and Atlantic-facing elegance', priceFrom: '$4.8M', type: 'branded', status: 'under-construction', imageIndex: 11 },
  ...
  { id: 'centris-pinecrest', name: 'Centris Pinecrest', areaId: 'pinecrest', areaName: 'Pinecrest', tagline: 'Estate-style living in one of Miami\'s most prized enclaves', priceFrom: '$2.9M', type: 'luxury', status: 'pre-construction', imageIndex: 10 },
  ...
  { id: 'gaia-residences-hollywood', name: 'Gaia Residences Hollywood', areaId: 'hollywood', areaName: 'Hollywood', tagline: 'Contemporary homes inspired by sea breezes and light', priceFrom: '$790K', type: 'residential', status: 'pre-construction', imageIndex: 3 },
  ...
  { id: 'the-standard-residences-midtown', name: 'The Standard Residences Midtown', areaId: 'midtown-miami', areaName: 'Midtown Miami', tagline: 'Playful hospitality and curated urban wellness', priceFrom: '$1.05M', type: 'branded', status: 'under-construction', imageIndex: 5 },
  ...
  { id: 'tula-residences-midtown', name: 'Tula Residences', areaId: 'midtown-miami', areaName: 'Midtown Miami', tagline: 'Boutique urban living with clean architectural lines', priceFrom: '$920K', type: 'luxury', status: 'pre-construction', imageIndex: 8 },
  { id: 'alba-florida-city', name: 'Alba Florida City', areaId: 'florida-city', areaName: 'Florida City', tagline: 'Freshly designed homes at the gateway to the Keys', priceFrom: '$420K', type: 'residential', status: 'under-construction', imageIndex: 2 },
  { id: 'oasis-florida-city', name: 'Oasis Florida City', areaId: 'florida-city', areaName: 'Florida City', tagline: 'A new neighborhood built around comfort and access', priceFrom: '$435K', type: 'residential', status: 'pre-construction', imageIndex: 4 },
  ...
  { id: 'nomad-residences-wynwood', name: 'Nomad Residences Wynwood', areaId: 'wynwood', areaName: 'Wynwood', tagline: 'A flexible ownership concept rooted in culture and design', priceFrom: '$760K', type: 'branded', status: 'under-construction', imageIndex: 6 },
  ...
  { id: 'tula-residences-north-bay', name: 'Tula Residences North Bay', areaId: 'north-bay-village', areaName: 'North Bay Village', tagline: 'Boutique waterfront residences with an intimate scale', priceFrom: '$790K', type: 'luxury', status: 'pre-construction', imageIndex: 7 },
  { id: 'w-pompano-beach-residences', name: 'W Pompano Beach Residences', areaId: 'pompano-beach', areaName: 'Pompano Beach', tagline: 'Lifestyle-driven beachfront ownership with W flair', priceFrom: '$1.45M', type: 'branded', status: 'pre-construction', imageIndex: 5 },
  { id: 'envy-residences-pompano', name: 'Envy Residences Pompano', areaId: 'pompano-beach', areaName: 'Pompano Beach', tagline: 'Contemporary coastal residences with striking water views', priceFrom: '$995K', type: 'luxury', status: 'under-construction', imageIndex: 11 },
  { id: 'kempinski-residences-design-district', name: 'Kempinski Residences Design District', areaId: 'miami-design-district', areaName: 'Miami Design District', tagline: 'European hospitality and couture-adjacent living', priceFrom: '$1.8M', type: 'branded', status: 'pre-construction', imageIndex: 0 },
  ...
  { id: 'faena-residences-miami-river', name: 'Faena Residences Miami River', areaId: 'miami-river', areaName: 'Miami River', tagline: 'A visionary branded community overlooking the river bend', priceFrom: '$1.95M', type: 'branded', status: 'pre-construction', imageIndex: 1 },
  ...
  { id: 'doppio-orlando', name: 'Doppio Orlando', areaId: 'orlando', areaName: 'Orlando', tagline: 'A dual-lifestyle resort concept near Orlando\'s major attractions', priceFrom: '$630K', type: 'resort', status: 'pre-construction', imageIndex: 8 },
  { id: 'dania-beach-residences', name: 'Dania Beach Residences', areaId: 'dania-beach', areaName: 'Dania Beach', tagline: 'Modern coastal living near marina, airport, and beach', priceFrom: '$720K', type: 'luxury', status: 'pre-construction', imageIndex: 4 },
];
