...
const translations: Record<Lang, any> = {
    es: {
        ...
        pages: {
            areas: {
                title: "Áreas",
                photoAlt: "Foto de la sección introductoria de {title}",
            },
            desarrollos: {
                title: "Desarrollos",
                envyResidence: {
            ...
            aliados: {
                hueHouseAlt: "Hue House",
                manzioneDesignAlt: "Manzione S. Design",
                manzionePropertiesAlt: "Manzione Properties",
            },
            contacto: {
                title: "Contacto",
            ...
            project: {
                ...
                bannerAlt: "Banner del proyecto {title}",
                galleryImageAlt: "Imagen de la galería {index}",
                buildingFields: {
                    location: "Ubicación",
                    builder: "Constructora",
                    constructionYear: "Año de Construcción",
                    squareFeet: "Tamaño de viviendas en pies cuadrados",
                },
                pdf: {
                    brochure: "Brochure",
                    hoja: "Hoja de Datos",
            ...
            admin: {
                login: {
                    ...
                    missingCredentials: "Por favor, ingrese email y contraseña",
                    invalidCredentials: "Email o contraseña incorrectos",
                    genericError: "Error al iniciar sesión. Por favor, intente de nuevo.",
                },
                editor: {
    ...
    en: {
        ...
        pages: {
            areas: {
                title: "Areas",
                photoAlt: "Photo from the {title} introductory section",
            },
            desarrollos: {
                title: "Developments",
                envyResidence: {
            ...
            project: {
                ...
                bannerAlt: "Project banner {title}",
                galleryImageAlt: "Gallery image {index}",
                buildingFields: {
                    location: "Location",
                    builder: "Builder",
                    constructionYear: "Construction Year",
                    squareFeet: "Home size in square feet",
                },
                pdf: {
                    brochure: "Brochure",
                    hoja: "Spec Sheet",
