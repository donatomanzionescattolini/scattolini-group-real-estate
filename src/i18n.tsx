    ...
    es: {
        ...
        pages: {
            ...
            editor: {
                ...
                selectDesarrolloToDelete: "Seleccione un desarrollo para eliminar",
                selectArea: "Seleccione un área para editar",
                selectAreaToDelete: "Seleccione un área para eliminar",
                areaLabel: "Área",
                ...
                deleting: "Eliminando...",
                refresh: "Actualizar",
                noDesarrollos: "Aún no hay desarrollos guardados.",
                noAreas: "Aún no hay áreas guardadas.",
                confirmDeleteDesarrollo: "¿Seguro que desea eliminar este desarrollo?",
                confirmDeleteArea: "¿Seguro que desea eliminar esta área?",
                areaDeleteCascadeIntro: "Eliminar esta área también eliminará los siguientes proyectos:",
                areaDeleteCascadeConfirm: "¿Desea continuar?",
                tabs: {
                    desarrollos: "Desarrollos",
                    areas: "Áreas",
                },
                ...
                address: {
                    ...
                    mustSelect: "Debe seleccionar una dirección de la lista antes de guardar.",
                    validation: "Seleccione una dirección de las sugerencias antes de continuar.",
                    lookupError: "No se pudieron cargar sugerencias de dirección en este momento.",
                },
                messages: {
                    desarrolloSaved: "Desarrollo guardado exitosamente",
                    desarrolloSaveError: "Error al guardar el desarrollo",
                    desarrolloLoadError: "Error al cargar desarrollos",
                    desarrolloDeleted: "Desarrollo eliminado exitosamente",
                    desarrolloDeleteError: "Error al eliminar el desarrollo",
                    areaSaved: "Área guardada exitosamente",
                    areaSaveError: "Error al guardar el área",
                    areaLoadError: "Error al cargar áreas",
                    areaDeleted: "Área eliminada exitosamente",
                    areaDeleteError: "Error al eliminar el área",
                },
            ...
            services: {
                ...
                realEstateDesc: "Compra, venta y asesoramiento experto en bienes raíces de lujo en el sur de Florida.",
                propertyManagementDesc: "Administración de propiedades con servicio completo para propietarios e inversores.",
                interiorDesignDesc: "Diseño de interiores exclusivo que transforma espacios en hogares de ensueño.",
            },
            project: {
        ...
        desarrollos: {
            ...
            "vista-harbor": {
                titulo: "Vista Harbor Residences & Yacht Club",
                slogan: "Vida de lujo a orillas del río Miami",
                introduccion: {
                    0: "Continuando la visión transformadora de Henry Pino sobre el río Miami, ALTA Development presenta Vista Harbor Residences & Yacht Club — una comunidad de condominios de 12 pisos con 242 residencias y 37,000 pies cuadrados de amenidades exclusivas, frente a 650 pies del pintoresco río Miami.",
                    1: "Distribuidas en dos torres independientes con lobbies separados, la colección incluye estudios y residencias de uno a cuatro dormitorios. Este audaz diseño moderno ofrece un acceso inigualable al río, con vistas impresionantes y conectividad directa a la Bahía Biscayne y lo mejor de Miami.",
                },
                caracteristicas: {
                    edificio: {
                        ubicacion: "Ubicación",
                        ubicacionValor: "A orillas del río Miami, Miami, FL",
                        desarrollador: "Desarrollador",
                        desarrolladorValor: "ALTA Development",
                        pisos: "Pisos",
                        pisosValor: "12 niveles — dos torres independientes (Este y Oeste)",
                        unidades: "Residencias",
                        unidadesValor: "242 residencias",
                        amenidades: "Amenidades",
                        amenidadesValor: "37,000 pies cuadrados de amenidades exclusivas",
                        frente: "Frente al río",
                        frenteValor: "650 pies sobre el río Miami",
                        alquiler: "Torre Oeste: renta a corto plazo permitida (mínimo 30 días), oportunidad de inversión llave en mano",
                        hospital: "A minutos del campus de salud de la Universidad de Miami y del Hospital Jackson Memorial",
                    },
                    residencias: {
                        tipos: "Tipos de unidades",
                        tipos1: "Estudios, residencias de 1, 2, 3 y 4 dormitorios",
                        rangoPrecio: "Desde $648,900",
                        vistas: "Impresionantes vistas al río Miami y a la Bahía Biscayne",
                        pisoACielo: "Ventanas de piso a techo en todas las residencias",
                        cocina: "Cocinas gourmet con acabados de alta gama",
                        paquetes: "Paquetes de amueblado disponibles (diseño Adriana Hoyos) — listo para alquilar",
                        penthouse: "Colección de penthouses disponible (unidades PH)",
                    },
                    amenidades: {
                        muelle: "Muelles privados — navegue por la ciudad directamente desde su hogar (Yacht Club)",
                        piscina: "Piscina en rooftop con vistas al río y la ciudad",
                        gym: "Gimnasio de última generación",
                        pickleball: "Canchas de pickleball",
                        business: "Centro de negocios",
                        lobby: "Lobbies exclusivos (independientes por cada torre)",
                        alquilerServicio: "Servicios de gestión de alquiler a corto plazo en el edificio",
                        acceso: "Acceso rápido a Downtown Miami, Midtown, Edgewater, Miami Beach, Design District, Aeropuerto Internacional de Miami, Puerto de Miami y estación Brightline",
                        riverLanding: "A 5 minutos del centro comercial River Landing — Publix, 9 restaurantes y 21 tiendas",
                    },
                },
            },
            "kempinski-residences": {
                titulo: "Kempinski Residences Miami Design District",
                slogan: "Refinamiento europeo redefinido en Miami",
                direccion: "3801 & 3883 Biscayne Blvd, Miami, FL 33137",
                introduccion: {
                    0: "Kempinski Residences Miami Design District presenta un hito del lujo europeo en una de las direcciones más prestigiosas de Miami. Ubicado en 3801 y 3883 Biscayne Blvd — en la entrada al Miami Design District™ — este desarrollo de dos torres trae la legendaria marca hotelera Kempinski a través de dos torres residenciales de 23 pisos, unidas por un exclusivo puente de amenidades en el cuarto piso.",
                    1: "Con 64 residencias por torre, 22 suites privadas para huéspedes, 6 townhomes y aproximadamente 70,000 pies cuadrados de amenidades curadas, Kempinski Residences ofrece un estilo de vida sin igual rodeado de boutiques de lujo, restaurantes de alta cocina, instituciones culturales y vistas panorámicas de la Bahía Biscayne y el horizonte de Miami.",
                },
                caracteristicas: {
                    edificio: {
                        ubicacion: "Dirección",
                        ubicacionValor: "3801 & 3883 Biscayne Blvd, Miami, FL 33137",
                        ubicacionDesc: "Ubicación",
                        ubicacionDescValor: "Puerta de entrada al Miami Design District™",
                        torres: "Torres",
                        torresValor: "Dos torres residenciales de 23 pisos (Norte y Sur)",
                        unidades: "Residencias",
                        unidadesValor: "64 residencias por torre + 22 suites privadas + 6 townhomes",
                        amenidades: "Amenidades",
                        amenidadesValor: "Aprox. 70,000 pies cuadrados en ambas torres",
                        puente: "Puente de Amenidades",
                        puenteValor: "Puente en el cuarto piso que conecta ambas torres",
                        concierge: "Conserje 24 horas capacitado por Kempinski",
                        carService: "Servicio de auto privado de lujo",
                        porteCochere: "Porte-Cochère privada con elementos acuáticos",
                        parking: "Estacionamiento estructurado para residentes y huéspedes",
                    },
                    residencias: {
                        tipos: "Tipos de Unidades",
                        tiposValor: "2 Hab / 2.5 Baños + Den y 4 Hab / 4.5 Baños + Den",
                        precio: "Precio Inicial",
                        precioValor: "Desde $3,895,900",
                        techos: "Techos de 11' en sala, habitaciones, den y balcón",
                        balcon: "Balcones de 10' de profundidad con vistas a la Bahía Biscayne",
                        elevador: "Lobby privado de ascensor por residencia",
                        closet: "Clóset privado de mayordomo",
                        piedra: "Acabados en piedra natural en toda la residencia, curados por Rockwell Group",
                        lavanderia: "Cuarto de lavandería en cada residencia",
                        cocina: "Cocina",
                        cocinaValor: "Paquete completo de electrodomésticos Gaggenau, isla con cascada, encimeras de piedra natural, gabinetes personalizados por Rockwell Group",
                        suite: "Suite Principal",
                        suiteValor: "Griferías Kallista, walk-in closet amplio, bañera independiente, inodoro inteligente Kohler Leap",
                    },
                    amenidades: {
                        lap: "Piscina de nado de 85' con plataforma solar",
                        beach: "Piscina de entrada tipo playa con plataforma solar",
                        cabanas: "Cabañas al aire libre, tumbonas y cabañas sociales junto a la piscina",
                        outdoor: "Teatro al aire libre, deck de juegos y lounge exterior",
                        padel: "Cancha de pádel en planta baja y parque para perros",
                        wellness: "Santuario de bienestar: inmersión fría, sauna infrarrojo, sauna seco, baños de vapor, jardín de meditación y yoga",
                        spa: "Spa mixto con salas de tratamiento privadas y lounge de relajación",
                        gym: "Centro de fitness de última generación + estudio de yoga y pilates",
                        familia: "Splash pad, parque infantil, sala de juegos, sala recreativa, simulador F1, simulador de golf y sala para adolescentes",
                        social: "Owner's Lounge, lounge de vinos y cigarros, comedor privado, cocina del chef, sala de música y sala de podcast",
                        business: "Centro de negocios y sala de juntas ejecutiva privada",
                        cafe: "Sunrise Café y Wellness Café con desayuno diario",
                        beach2: "Servicio de playa fuera del sitio",
                    },
                },
            },
            doppio: {
    ...
    en: {
        ...
        pages: {
            ...
            editor: {
                ...
                selectDesarrolloToDelete: "Select a development to delete",
                selectArea: "Select an area to edit",
                selectAreaToDelete: "Select an area to delete",
                areaLabel: "Area",
                ...
                deleting: "Deleting...",
                refresh: "Refresh",
                noDesarrollos: "No developments found yet.",
                noAreas: "No areas found yet.",
                confirmDeleteDesarrollo: "Are you sure you want to delete this development?",
                confirmDeleteArea: "Are you sure you want to delete this area?",
                areaDeleteCascadeIntro: "Deleting this area will also delete the following projects:",
                areaDeleteCascadeConfirm: "Do you want to continue?",
                tabs: {
                    desarrollos: "Developments",
                    areas: "Areas",
                },
                ...
                address: {
                    ...
                    mustSelect: "You must click one suggested address before saving.",
                    validation: "Please choose an address from the suggestions before continuing.",
                    lookupError: "We could not fetch address suggestions right now.",
                },
                messages: {
                    desarrolloSaved: "Development saved successfully",
                    desarrolloSaveError: "Error saving development",
                    desarrolloLoadError: "Error loading developments",
                    desarrolloDeleted: "Development deleted successfully",
                    desarrolloDeleteError: "Error deleting development",
                    areaSaved: "Area saved successfully",
                    areaSaveError: "Error saving area",
                    areaLoadError: "Error loading areas",
                    areaDeleted: "Area deleted successfully",
                    areaDeleteError: "Error deleting area",
                },
            ...
            services: {
                ...
                realEstateDesc: "Buying, selling, and expert advisory on luxury real estate in South Florida.",
                propertyManagementDesc: "Full-service property management for owners and investors.",
                interiorDesignDesc: "Exclusive interior design that transforms spaces into dream homes.",
            },
            project: {
        ...
        desarrollos: {
            ...
            "vista-harbor": {
                titulo: "Vista Harbor Residences & Yacht Club",
                slogan: "Luxury living along the Miami River",
                introduccion: {
                    0: "Continuing Henry Pino's vision of transformation along the Miami River, ALTA Development introduces Vista Harbor Residences & Yacht Club — a 12-story condominium community featuring 242 residences and 37,000 SF of exclusive amenities, fronting 650 feet along the picturesque Miami River.",
                    1: "Spread across two separate towers with independent lobbies, the collection includes studios and one- to four-bedroom residences. This bold modern design offers unrivaled riverfront access, providing residents with stunning views and seamless connectivity to Biscayne Bay and the best of Miami.",
                },
                caracteristicas: {
                    edificio: {
                        ubicacion: "Location",
                        ubicacionValor: "Along the Miami River, Miami, FL",
                        desarrollador: "Developer",
                        desarrolladorValor: "ALTA Development",
                        pisos: "Floors",
                        pisosValor: "12 stories — two separate towers (East & West)",
                        unidades: "Residences",
                        unidadesValor: "242 residences",
                        amenidades: "Amenities",
                        amenidadesValor: "37,000 SF of exclusive amenities",
                        frente: "River Frontage",
                        frenteValor: "650 feet along the Miami River",
                        alquiler: "West Tower: minimum 30-day short-term rental permitted, turnkey investment opportunity",
                        hospital: "Minutes from University of Miami Health campus and Jackson Memorial Hospital",
                    },
                    residencias: {
                        tipos: "Unit Types",
                        tipos1: "Studios, 1-, 2-, 3-, and 4-bedroom residences",
                        rangoPrecio: "Starting from $648,900",
                        vistas: "Stunning Miami River and Biscayne Bay views",
                        pisoACielo: "Floor-to-ceiling windows in all residences",
                        cocina: "Gourmet kitchens with high-end finishes",
                        paquetes: "Furniture package options available (Adriana Hoyos design) — turnkey rental-ready",
                        penthouse: "Penthouse collection also available (PH units)",
                    },
                    amenidades: {
                        muelle: "Private docks — cruise the city directly from your home (Yacht Club)",
                        piscina: "Rooftop pool with stunning river and city views",
                        gym: "State-of-the-art fitness center / gym",
                        pickleball: "Pickleball courts",
                        business: "Business center",
                        lobby: "Signature lobbies (independent for each tower)",
                        alquilerServicio: "On-site short-term rental support services",
                        acceso: "Quick access to Downtown Miami, Midtown, Edgewater, Miami Beach, Design District, Miami International Airport, Port of Miami, and Brightline Train Station",
                        riverLanding: "5-minute drive to River Landing mall — Publix, 9 restaurants, 21 retailers",
                    },
                },
            },
            "kempinski-residences": {
                titulo: "Kempinski Residences Miami Design District",
                slogan: "European refinement redefined in Miami",
                direccion: "3801 & 3883 Biscayne Blvd, Miami, FL 33137",
                introduccion: {
                    0: "Kempinski Residences Miami Design District introduces a landmark of European luxury to one of Miami's most prestigious addresses. Located at 3801 & 3883 Biscayne Blvd — at the gateway to the Miami Design District™ — this dual-tower development brings the legendary Kempinski hospitality brand to life through two 23-story residential towers, united by an exclusive amenity bridge on the fourth floor.",
                    1: "With 64 residences per tower, 22 private guest suites, 6 townhomes, and approximately 70,000 square feet of curated amenities, Kempinski Residences offers an unparalleled lifestyle surrounded by luxury retail, chef-driven dining, cultural institutions, and sweeping views of Biscayne Bay and the Miami skyline.",
                },
                caracteristicas: {
                    edificio: {
                        ubicacion: "Address",
                        ubicacionValor: "3801 & 3883 Biscayne Blvd, Miami, FL 33137",
                        ubicacionDesc: "Location",
                        ubicacionDescValor: "Gateway to the Miami Design District™",
                        torres: "Towers",
                        torresValor: "Two 23-story residential towers (North & South)",
                        unidades: "Residences",
                        unidadesValor: "64 residences per tower + 22 private guest suites + 6 townhomes",
                        amenidades: "Amenities",
                        amenidadesValor: "Approx. 70,000 sq ft across both towers",
                        puente: "Amenity Bridge",
                        puenteValor: "Fourth-floor bridge connecting both towers",
                        concierge: "24-Hour Concierge trained by Kempinski",
                        carService: "Luxury house car service",
                        porteCochere: "Private Porte-Cochère with water features",
                        parking: "Onsite structured parking for residents and guests",
                    },
                    residencias: {
                        tipos: "Unit Types",
                        tiposValor: "2 Bed / 2.5 Bath + Den and 4 Bed / 4.5 Bath + Den",
                        precio: "Starting Price",
                        precioValor: "From $3,895,900",
                        techos: "11' high ceilings in Great Room, Bedrooms, Den and Balcony",
                        balcon: "10' deep balconies with unobstructed Biscayne Bay views",
                        elevador: "Private elevator lobby per residence",
                        closet: "Private valet closet",
                        piedra: "Natural stone finishes throughout, curated by Rockwell Group",
                        lavanderia: "Laundry room in each residence",
                        cocina: "Kitchen",
                        cocinaValor: "Full Gaggenau appliance package, waterfall island, natural stone countertops, custom cabinetry by Rockwell Group",
                        suite: "Primary Suite",
                        suiteValor: "Kallista fixtures, oversized walk-in closet, freestanding tub, Kohler Leap Smart Toilet",
                    },
                    amenidades: {
                        lap: "85' Lap Pool with sun shelf",
                        beach: "Beach entry pool with sun shelf",
                        cabanas: "Open-air cabanas, daybeds & poolside social cabanas",
                        outdoor: "Outdoor theater, games deck & outdoor lounge",
                        padel: "Ground level Padel court & dog park",
                        wellness: "Wellness sanctuary: cold plunge, infrared sauna, dry sauna, steam rooms, meditation & yoga garden",
                        spa: "Coed spa with private treatment rooms & relaxation lounge",
                        gym: "State-of-the-art fitness center + yoga & pilates movement studio",
                        familia: "Children's splash pad, playground, playroom, game room, F1 simulator, golf simulator & teen's room",
                        social: "Owner's Lounge, wine & cigar lounge, private dining room, chef's kitchen, music room & podcast room",
                        business: "Business center & private executive boardroom",
                        cafe: "Sunrise Café & Wellness Café offering daily breakfast",
                        beach2: "Offsite beach service",
                    },
                },
            },
            doppio: {
