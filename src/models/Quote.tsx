...
const quotes = [new Quote(
    ...
    "Miguel Ferrara"), new Quote({
        ...
        en: "The most important quality for an investor is temperament, not intellect... You need a temperament that neither derives great pleasure from being with the crowd or against the crowd."
    }
    , "Warren Buffett"),
    new Quote({
    ...
    new Quote({
            ...
            en: "Buy on the fringe and wait. Buy land near a growing city! Buy real estate when other people want to sell. Hold what you buy!"
        }
        , "John Jacob Astor"), new Quote({
            es: "Cuando inviertes, estás comprando un día que no tienes que trabajar.",
            en: "When you invest, you are buying a day you don't have to work."
        },
