...
const LaBaia = new Desarrollo();
LaBaia.nombre = 'la-baia';
LaBaia.caracteristicas = {
    edificio: <dl>
        <dt>Ubicación</dt>
        ...
        <ul>
            ...
            <li>Terrazas privadas con vistas despejadas de la Bahía de Biscayne, el Océano Atlántico, Bal Harbour, Miami
        ...
        <ul>
            <li>20,000 pies cuadrados de comodidades estilo centro turístico; incluyendo más de 8,500 pies cuadrados de
            ...
            <li>Muelle de lanzamiento de deportes acuáticos con kayaks, inflables y tablas de remo proporcionadas a los
                residentes
            </li>
            <li>Terraza Sunrise con asientos en el muelle con vistas a la Bahía de Biscayne</li>
            <li>Césped junto al muelle con asientos frente al mar, tumbonas con enrejados florales y hamacas colgantes
