...
const LaMaré = new Desarrollo();

LaMaré.nombre = "la-maré";
LaMaré.caracteristicas = {
    edificio: (
        <>
            <dl>
                <dt>Ubicación</dt>
...
LaMaré.titulo = "La Maré";
LaMaré.subtitulo = "Regency";
LaMaré.numberOfImages = 36;
LaMaré.banner = true;

export default LaMaré;
