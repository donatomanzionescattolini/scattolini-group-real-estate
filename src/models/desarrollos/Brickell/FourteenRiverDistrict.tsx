...
const FourteenRiverDistrict = new Desarrollo();

FourteenRiverDistrict.nombre = "14-river-district";
FourteenRiverDistrict.banner = true;
FourteenRiverDistrict.caracteristicas = {
    edificio: (
        <ul>
...
FourteenRiverDistrict.introduccion = [
...
FourteenRiverDistrict.titulo = "14 River District";
FourteenRiverDistrict.subtitulo = "";
FourteenRiverDistrict.numberOfImages = 27;
FourteenRiverDistrict.direccion = "1420 NW 14th Ave, Miami, FL 33125, Estados Unidos"
export default FourteenRiverDistrict;