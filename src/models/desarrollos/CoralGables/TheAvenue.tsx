...
const TheAvenue = new Desarrollo();
TheAvenue.nombre = "the-avenue";
TheAvenue.caracteristicas = {
    edificio: (
        <>
            <dl>
                <dt>Ubicación</dt>
...
TheAvenue.titulo = "The Avenue";
TheAvenue.subtitulo = "La esencia de la avenida Coral Gables";
TheAvenue.numberOfImages = 27;
TheAvenue.banner = true;
export default TheAvenue;