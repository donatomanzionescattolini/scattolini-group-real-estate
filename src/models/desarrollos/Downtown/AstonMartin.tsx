...
const AstonMartin = new Desarrollo();

AstonMartin.banner = true;

AstonMartin.nombre = "aston-martin";
AstonMartin.video =
    <iframe
        width="100%"
        height="700"
...
AstonMartin.direccion = "300 Biscayne Boulevard Way";
AstonMartin.caracteristicas = {
    edificio: (
...
;
AstonMartin.titulo = "Aston Martin Residences";
AstonMartin.subtitulo = "";
AstonMartin.numberOfImages = 29;
