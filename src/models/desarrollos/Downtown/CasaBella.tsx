...
const CasaBella = new Desarrollo();
CasaBella.banner = true;

CasaBella.nombre = "casa-bella";
CasaBella.caracteristicas = {
    edificio: (
        <ul>
...
CasaBella.introduccion = [
    ...
    "CasaBella Residences by B&B Italia ha colaborado con los artistas italianos más célebres para curar su hogar con obras maestras selectas de las colecciones de B&B Italia.",
];
CasaBella.titulo = "Casa Bella Residences";
CasaBella.direccion = "";
CasaBella.subtitulo = "Bienvenido a la cima de la sofisticada vida italiana";
CasaBella.numberOfImages = 16;

export default CasaBella;