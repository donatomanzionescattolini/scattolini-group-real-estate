...
const Cipriani = new Desarrollo();


Cipriani.banner = true;

Cipriani.nombre = "cipriani";
Cipriani.titulo = "Cipriani Residences";
Cipriani.subtitulo = "";
Cipriani.numberOfImages = 14;
Cipriani.introduccion = [
    "\n" +
