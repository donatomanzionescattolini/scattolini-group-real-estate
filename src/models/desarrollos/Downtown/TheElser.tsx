...
const TheElser = new Desarrollo();
TheElser.caracteristicas = {
    edificio:
        (
            <ul>
                <li>
...
TheElser.nombre = "the-elser";
TheElser.introduccion = [
...
TheElser.banner = true;
TheElser.titulo = "The Elser Residences";
TheElser.subtitulo = "Lugar bullicioso y vistas brillantes de la bahía de Biscayne";
TheElser.numberOfImages = 44;
TheElser.video =
    <iframe
        width="1280"
        height="720"
