...
const AriaReserve = new Desarrollo();
AriaReserve.nombre = " aria-reserve";
AriaReserve.caracteristicas = {
    edificio: (
        <>
            <ul>
                <li>62 Pisos</li>
...
AriaReserve.titulo = " Aria Reserve";
AriaReserve.direccion = "708 NE 24th St, Miami, FL 33137"
//   video={
//     <iframe
//       width="1280"
//       height="720"
...
//     ></iframe>
//   }
AriaReserve.subtitulo = " ";
AriaReserve.numberOfImages = 59;
AriaReserve.banner = true;
export default AriaReserve;