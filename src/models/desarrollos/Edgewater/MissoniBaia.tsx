...
const MissoniBaia = new Desarrollo();
MissoniBaia.nombre = "missoni-baia";
MissoniBaia.direccion = "700 NE 26th Ter, Miami, FL 33137"
MissoniBaia.caracteristicas = {
    edificio: (
        <>
            <ul>
                <li>Pisos: 57</li>
                <li>Unidades: 249</li>
                <li>Entrega: 2024</li>
                <li>Ubicación: 700 NE 26th Ter, Miami, FL 33137</li>
            </ul>
        </>
    ),
    residencias: (
        <>
            <ul>
                ...
                <li>Vestidores</li>
                <li>Residencias de una a cinco habitaciones</li>
                <li>Control de clima automatizado de la unidad</li>
                <li>Agua caliente centralizada</li>

                <br/>
                <strong>Baño principal</strong>
                <br/>
                <li>
    ...
    amenidades: (
        <>
            <ul>
                ...
                <br/>
                <strong>Amenidades por Piso</strong>
                <br/>
                <br/>
                <strong>Lobby</strong>
                <br/>
                ...
                <br/>
                <li>
                    Puente cerrado que conecta la torre con el estacionamiento
                </li>
                <li>Oficina del administrador dentro del edificio</li>
                <li>Sala de proyección privada</li>
                <li>Salón de belleza</li>
                <li>Club para Niños</li>
                <li>Spa para mascotas</li>
                <br/>
                <strong>Sexto Piso, Amenidades al Aire Libre</strong>
                <br/>
                <li>
                ...
                <li>
                    ...
                    pantalla de video y amplios sillones
                </li>
                <li>Salón para cenas y fiestas privadas de los residentes</li>
                <br/>
                ...
                <li>Vestidores para hombres y mujeres</li>
                <li>
                    Amplio spa exclusivo para residentes con sauna y salas de vapor
                    para hombres y mujeres y salas privadas de tratamiento y masajes
                    con regaderas
                </li>
                <br/>
                ...
                <br/>
                <strong>Ejercicio y Relajación</strong>
                <br/>
                <li>
                    Los condominios de lujo Missoni Baia ofrecen amplias
                    oportunidades de llevar un estilo de vida equilibrado y
                    saludable, que combine ejercicio y bienestar dentro de un lujoso
                ...
                <br/>
                <li>
                    Tenis: la terraza de servicios incluye una cancha de tenis de
                    tamaño reglamentario con vista a Biscayne Bay.
                </li>
                <br/>
                <strong>Miami Waterfront Condos: Spa</strong>
                <br/>
                <li>
                    Spa: el spa de Missoni Baia no es como cualquier otro spa en
...
MissoniBaia.introduccion = [
    "Las 249 residencias del condominio en EdgewaterComponent de Missoni Baia celebran el eterno encanto de la vida frente al agua con un estilo relajado y moderno. En el horizonte de Miami y sobre la costa de East EdgewaterComponent, se delinea una figura prominente: Missoni Baia; con una elevación de 57 pisos que abarcan una impresionante longitud de 200 pies a lo largo de Biscayne Bay.",
    "Con un diseño vanguardista y de alto rendimiento, realizado por la prestigiosa firma internacional, Asymptote Architecture, los nuevos y lujosos condominios en EdgewaterComponent de Missoni Baia capturan el espíritu innovador y soñador de Missoni. Missoni Baia es como ninguna otra torre residencial en Miami.",
];
MissoniBaia.titulo = "Missoni Baia";
MissoniBaia.subtitulo = "";
MissoniBaia.numberOfImages = 51;
MissoniBaia.banner = true;
export default MissoniBaia;