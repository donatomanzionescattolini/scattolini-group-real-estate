...
const FivePark = new Desarrollo();
FivePark.nombre = "five-park";
FivePark.area = MiamiBeach;
FivePark.direccion = "500 Alton Rd, Miami Beach, FL 33139, Estados Unidos";
FivePark.caracteristicas = {
    amenidades: (
        <>
...
FivePark.titulo = "Five Park";
FivePark.subtitulo = "Vida a un Nivel Superior";
FivePark.numberOfImages = 45;
FivePark.banner = true;
export default FivePark;
