...
const OnePark = new Desarrollo();
OnePark.nombre = "one-park";
OnePark.area = MiamiBeach;
OnePark.caracteristicas = {
    edificio: (
        <>
            <ul className="list">
...
OnePark.titulo = "One Park";
OnePark.subtitulo = <em>by Turnberry</em>;
OnePark.numberOfImages = 27;
OnePark.banner = true;
OnePark.direccion = "2411 Laguna Circle, North Miami, FL 33181";
