...
const SeventyTwoPark = new Desarrollo();
SeventyTwoPark.area = MiamiBeach;

SeventyTwoPark.nombre = "72-park";
SeventyTwoPark.caracteristicas = {
    edificio: (
        <ul>
            <li>Pisos: 22</li>
...
SeventyTwoPark.titulo = "72 Park";
SeventyTwoPark.subtitulo =
    <span className="pb-0 mb-0">
          La vida en Miami Beach <em>redefinida</em>
        </span>
;SeventyTwoPark.numberOfImages = 19;
SeventyTwoPark.banner = true;

export default SeventyTwoPark;
