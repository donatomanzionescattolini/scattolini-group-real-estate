...
const ShomaBay = new Desarrollo();
ShomaBay.nombre = "shoma-bay";
ShomaBay.area = NorthBayVillage;
ShomaBay.direccion = "1850 John F Kennedy Causeway, North Bay Village, FL 33141";
ShomaBay.caracteristicas = {
    edificio: (
        <ul>
...
ShomaBay.banner = true;
ShomaBay.titulo = "Shoma Bay";
ShomaBay.subtitulo = "";
ShomaBay.numberOfImages = 16;
ShomaBay.video =
