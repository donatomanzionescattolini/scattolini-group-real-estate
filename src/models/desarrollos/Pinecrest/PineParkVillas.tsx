...
const PineParkVillas = new Desarrollo();
PineParkVillas.nombre = "pine-park-villas";
PineParkVillas.caracteristicas = {
    edificio: (
        <>
            <p>
...
PineParkVillas.titulo = "Pine Park Villas";
PineParkVillas.subtitulo = "Estilo de vida redefinido";
PineParkVillas.numberOfImages = 33;
//   video={
//     <iframe
//       width="1280"
//       height="720"
...
//     ></iframe>
//   }
PineParkVillas.banner = true;
PineParkVillas.area = Pinecrest;
export default PineParkVillas;
