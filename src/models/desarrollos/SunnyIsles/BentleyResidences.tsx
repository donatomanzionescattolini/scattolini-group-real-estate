...
const BentleyResidences = new Desarrollo();

BentleyResidences.nombre = "bentley-residences";
BentleyResidences.area = SunnyIsles;

BentleyResidences.caracteristicas = {
    edificio: (
        <>
            <dl>
                <dt>Pisos</dt>
...
BentleyResidences.introduccion = [
...
BentleyResidences.video =
    ...
    ></iframe>
;
BentleyResidences.titulo = "Bentley Residences";
BentleyResidences.subtitulo = "Espacio que puedes abrazar";
BentleyResidences.numberOfImages = 47;
BentleyResidences.banner = true;
export default BentleyResidences;