...
const StRegis = new Desarrollo();

StRegis.area = SunnyIsles;
StRegis.numberOfImages = 52;
StRegis.nombre = "st-regis";
StRegis.titulo = "St. Regis® BrickellComponent";
StRegis.subtitulo = "Vivir exquisito es vivir extraordinario";
StRegis.introduccion = [
...
StRegis.banner = true;
StRegis.caracteristicas = {
    edificio: (
        <p>
            St. Regis® BrickellComponent se encuentra dentro de una red de conexiones de
    ...
    residencias: (
        <div>
            <p>
                ...
                penthouses y sky villas. St. Regis® BrickellComponent es una colección de
