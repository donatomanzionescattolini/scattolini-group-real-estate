...
const TheMansionsAtAcqualina = new Desarrollo();
TheMansionsAtAcqualina.area = SunnyIsles;
TheMansionsAtAcqualina.video =
    <iframe
        width="1280"
        height="720"
...
TheMansionsAtAcqualina.nombre = "the-mansions-at-acqualina";
TheMansionsAtAcqualina.caracteristicas = {
    edificio: (
        <>
            <dl>
                <dt>Pisos</dt>
...
TheMansionsAtAcqualina.introduccion = [
...
TheMansionsAtAcqualina.titulo = "The Mansions at Acqualina";
TheMansionsAtAcqualina.subtitulo = "Descubre la vida en condominio en Sunny Isles Beach";
TheMansionsAtAcqualina.numberOfImages = 24;
TheMansionsAtAcqualina.banner = true;
export default TheMansionsAtAcqualina;