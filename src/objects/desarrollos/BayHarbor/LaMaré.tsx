...
export default function LaMaré() {
    ...
    LaMaréObject.caracteristicas = {
        edificio: (
            <>
                ...
                <ul>
                    <li>Hermosa costa ajardinada frente a la bahÃ­a</li>
                    ...
                    <li>Acogedor vestÃ­bulo de entrada y salón con portero las 24 horas</li>
                    <li>Cómodas trasteras privadas para cada residencia</li>
                    <li>8 pisos con 33 residencias amplias, aireadas y llenas de luz, muchas de ellas con vistas a la bahÃ­a</li>
                    <li>Distribuciones de planos de planta de 2 a 4 dormitorios que van desde 1,567 a mÃ¡s de 4,200 pies cuadrados.</li>
        ...
        residencias: (
            <>
                <ul>
                    ...
                    <li>Cocinas Poliform personalizadas con encimeras de piedra con un conjunto de electrodomésticos Miele de primera lÃ­nea, que incluye sistema de café y nevera para vinos</li>
                    <li>Elegantes accesorios italianos en cocinas y baños de by Antonio Lupi</li>
                    <li>Vistas panorÃ¡micas de la bahÃ­a a través de ventanas de piso a techo de 9 pies</li>
                    <li>2 amplios Ã¡ticos, cada uno con piscinas privadas en la azotea</li>
        ...
        amenidades: (
            <dl><dt>Colección Regency</dt>
                <dd><ul>
                    ...
                    <li>Espacio al aire libre frente a la bahÃ­a con jardines y Ã¡reas de descanso</li>
                    <li>Gimnasio de Ãºltima generación</li>
                    <li>Instalaciones de spa con vapor y sauna</li>
                    <li>Terraza ajardinada de la piscina en la azotea tipo centro turÃ­stico con piscina infinita, jacuzzi, tumbonas y tumbonas</li>
                    ...
                    <li>VestÃ­bulo de entrada y salón de bienvenida</li>
                    ...
                    <li>Cómodas trasteras privadas para cada residencia</li>
                    <li>Garaje de estacionamiento con 69 espacios de estacionamiento (2 espacios por residencia), asÃ­ como estacionamiento adicional cerrado y cerrado en la planta baja</li>
                </ul></dd>
                <dt>Colección Signature</dt>
                <dd><ul>
                    <li>Espacio al aire libre frente a la bahÃ­a con paisajismo y Ã¡reas de descanso</li>
                    <li>Bodega</li>
                    <li>Gran habitación para el disfrute de amigos y familiares</li>
                    <li>Terraza ajardinada de la piscina en la azotea tipo centro turÃ­stico con piscina, jacuzzi, tumbonas, tumbonas, cocina al aire libre y bar / salón</li>
                    <li>Muelles privados disponibles para los residentes</li>
                    <li>VestÃ­bulo de entrada y salón de bienvenida</li>
                    <li>Los ascensores semiprivados y privados llevan a los residentes directamente a sus hogares con sistema de cerradura con llave</li>
                    <li>Cómodas trasteras privadas para cada residencia</li>
    ...
    LaMaréObject.introduccion = [
        "La Maré se compone de dos exquisitas torres que ofrecen una experiencia de vida extraordinaria. El Regency Collection es un moderno edificio de cristal definido por su sorprendente belleza, sostenibilidad y refinada sensación de comodidad, con un interior en el que destaca una paleta suave y natural. La Signature Collection, por su parte, es una estructura contemporÃ¡nea de impresionante diseño con interiores armoniosos.AquÃ­, la exclusividad es la norma, ya que cada unidad cuenta con ventanas envolventes de suelo a techo que brindan una vista clara de su impresionante estética nÃ¡utica.Con componentes aerodinÃ¡micos, elementos tropicales y el generoso uso de piedra color arena, travertino y maderas aclaradas, los residentes disfrutan de privacidad y se ven envueltos en una atmósfera estilo resort",
    ];
