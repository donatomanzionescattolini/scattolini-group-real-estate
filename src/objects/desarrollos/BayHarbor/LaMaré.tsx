...
export default function LaMaré() {
        ...
        edificio: (
            <>
                ...
                <ul>
                    ...
                    <li>Acogedor vestíbulo de entrada y sal�n con portero las 24 horas</li>
        ...
        residencias: (
            <>
                <ul>
                    ...
                    <li>Cocinas Poliform personalizadas con encimeras de piedra con un conjunto de electrodom�sticos Miele de primera línea, que incluye sistema de caf� y nevera para vinos</li>
                    <li>Elegantes accesorios italianos en cocinas y baños de by Antonio Lupi</li>
                    <li>Vistas panor�micas de la bahía a trav�s de ventanas de piso a techo de 9 pies</li>
        ...
        amenidades: (
            <dl><dt>Colección Regency</dt>
                <dd><ul>
                    ...
                    <li>Espacio al aire libre frente a la bahía con jardines y �reas de descanso</li>
                    ...
                    <li>Vestíbulo de entrada y sal�n de bienvenida</li>
                ...
                <dd><ul>
                    <li>Espacio al aire libre frente a la bahía con paisajismo y �reas de descanso</li>
                    <li>Bodega</li>
                    <li>Gran habitación para el disfrute de amigos y familiares</li>
                    <li>Terraza ajardinada de la piscina en la azotea tipo centro turístico con piscina, jacuzzi, tumbonas, tumbonas, cocina al aire libre y bar / sal�n</li>
                    <li>Muelles privados disponibles para los residentes</li>
                    <li>Vestíbulo de entrada y sal�n de bienvenida</li>
                    <li>Los ascensores semiprivados y privados llevan a los residentes directamente a sus hogares con sistema de cerradura con llave</li>
                    <li>Cómodas trasteras privadas para cada residencia</li>
    ...
    LaMaréObject.introduccion = [
        "La Mar� se compone de dos exquisitas torres que ofrecen una experiencia de vida extraordinaria. El Regency Collection es un moderno edificio de cristal definido por su sorprendente belleza, sostenibilidad y refinada sensaci�n de comodidad, con un interior en el que destaca una paleta suave y natural. La Signature Collection, por su parte, es una estructura contempor�nea de impresionante dise�o con interiores armoniosos.Aquí, la exclusividad es la norma, ya que cada unidad cuenta con ventanas envolventes de suelo a techo que brindan una vista clara de su impresionante est�tica n�utica.Con componentes aerodin�micos, elementos tropicales y el generoso uso de piedra color arena, travertino y maderas aclaradas, los residentes disfrutan de privacidad y se ven envueltos en una atm�sfera estilo resort",
    ];
