...
export default function DolceAndGabbanaResidences(lang: "en" | "es" = "es") {
    ...
    DolceAndGabbanaResidences.numberOfRooms = {
        start: parseInt(getLocalizedField("numberOfRooms.start", "1"), 10) || 1,
        end: parseInt(getLocalizedField("numberOfRooms.end", "4"), 10) || 4
    };
