        ...
        residencias: (
            <>
                ...
                <ul>
                    ...
                    {" "}
                    <li> {getLocalizedField("caracteristicas.residencias.accesorios", "Accesorios modernos")}</li>
                    <li> {getLocalizedField("caracteristicas.residencias.cubiertas", "Cubiertas de cuarzo")}</li>
                    {" "}
