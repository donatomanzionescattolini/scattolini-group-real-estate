...
export default function IconBeachResidencesObject(lang: "en" | "es" = "es") {
    ...
    IconBeachResidences.caracteristicas = {
        ...
        edificio: <>
            <dl>
                <dt>{lang === "en" ? "Location" : "Ubicación"}</dt>
                <dd>{IconBeachResidences.ubicación}</dd>
                <dt>{lang === "en" ? "Number of Floors" : "Número de Pisos"}</dt>
                <dd>{IconBeachResidences.numberOfFloors}</dd>
                <dt>{lang === "en" ? "Number of Units" : "Número de Unidades"}</dt>
                <dd>{IconBeachResidences.numberOfUnits}</dd>
                <dt>{lang === "en" ? "Type of Units" : "Tipo de Unidades"}</dt>
                <dd>{IconBeachResidences.typeOfUnits}</dd>
                <dt>{lang === "en" ? "Year of Construction or Completion" : "Año de Construcción o Finalización"}</dt>
                <dd>{IconBeachResidences.estimatedCompletionYear}</dd>
                <dt>{lang === "en" ? "Number of Bedrooms" : "Número de Habitaciones"}</dt>
                <dd>{lang === "en" ? "1 to 3" : "1 a 3"}</dd>
            </dl>
        </>,
    };
