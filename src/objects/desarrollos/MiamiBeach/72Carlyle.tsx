    ...
    SeventyTwoCarlyleObject.caracteristicas = {
        edificio: <>
            ...
            <ul>
                ...
                <li>Smart building integrated with high-speed wireless fiber optic internet access in all common areas
                </li>
                <li>24-hour monitoring at all building access points</li>
                <li>Over 45,000 square feet of exclusive indoor and outdoor residential amenities, designed and curated
                    by Piero Lissoni. Resort-style pool with lush gardens and cabanas overlooking the Intracoastal canal
                </li>
                <li>Luxurious outdoor exhibition padel courts</li>
                <li>Lido terrace and gastronomic pergola for outdoor socializing</li>
                <li>Three interconnected social suites that can be combined for larger events, including the aperitif
                    lounge with multiple seating areas and a wine cellar with chef's table
                </li>
                ...
                <li>Luxurious panoramic rooftop terrace with gardens on the top floor of the building, dining areas,
                    bar, and ocean, park, Intracoastal canal, and Miami skyline views
                </li>
            </ul>
        </> : <>
            <ul>
                ...
                <li>Edificio inteligente integrado con acceso a internet por fibra óptica inalámbrica de alta velocidad
                    en
                    todas las áreas comunes
                </li>
                <li>Monitoreo las 24 horas en todos los puntos de acceso al edificio</li>
                <li>Más de 45,000 pies cuadrados de exclusivas comodidades residenciales interiores y exteriores,
                    diseñadas
                    y seleccionadas por Piero Lissoni Piscina de resort con lujosos jardines y cabañas con vistas al
                    canal
                    Intracostero
                </li>
                ...
                <li>Tres suites sociales interconectadas que pueden combinarse para eventos más grandes, incluyendo el
                    salón
                ...
                <li>Lujosa terraza panorámica con jardines en el último piso del edificio, áreas de comedor, bar y
                    vistas
            ...
            <ul>
                ...
                <li>Dramatic designs offer 14-foot-high ceilings and wraparound glass walls leading to private
                    terraces
                </li>
                <li>Select penthouses with Lissoni-designed entertainment terraces featuring private pool, ample seating
                    spaces, outdoor kitchen, wine cooler, and sink
                </li>
                ...
                <li>Most units offer five-fixture bathrooms, double vanity, freestanding tub, and separate rain shower
            ...
            <ul>
                ...
                <li>La mayoría de las unidades ofrecen baños con cinco accesorios, tocador doble, una tina independiente
                    y
