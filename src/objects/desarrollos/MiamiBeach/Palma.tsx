...
export default function Palma(lang: "en" | "es" = "es") {
    ...
    PalmaObject.caracteristicas = {
        ...
        residencias: lang === "en" ?
            <ul>
                <li>Luxury beachfront residences with modern, open designs. All residences are fully finished and
                    furnished by
                </li>
                <li>award-winning Studio Ramírez</li>
                <li>Panoramic ocean and bay views in select residences. Private balconies to enjoy the outdoors from
                    your home. Luxury 9-10 foot ceilings that provide spaciousness and light to your residence.
                    Floor-to-ceiling sliding glass doors with impact-resistant glass. Residences pre-wired for
                    high-speed internet and WiFi. Energy-efficient central air conditioning and heating system. Stacked
                    washer and dryer included. Spacious closets for your chic beachfront wardrobe
                </li>
                <li>KITCHEN</li>
                <li>Imported European cabinets with premium hardware. Bosch appliance package with refrigerator, oven,
                    stove, microwave, and dishwasher. Premium stone countertops and backsplashes for the ultimate
                    culinary experience. Contemporary stainless steel undermount sink. Elegant faucet with integrated
                    spray handle
                </li>
                <li>MASTER BATHROOM</li>
                <li>Imported European cabinets with premium hardware and drawer pulls. Premium stone countertops and
                    backsplashes. Rectangular porcelain sinks with elegant dual faucets (in select residences).
                    Custom-finished porcelain floors and walls in wet areas. Glass shower enclosures. Premium
                    European-style fixtures and accessories
                </li>
            </ul> :
            <ul>
                ...
                <li>Vistas panorámicas al océano y la bahía en algunas residencias Balcones privados para disfrutar el
                    aire libre desde tu hogar Techos de lujo de 9-10 pies que brindan amplitud y luz a tu residencia
                    Puertas corredizas de piso a techo a base de vidrio resistente a impactos Residencias pre-cableadas
                    para internet de alta velocidad y WiFi Sistema de aire acondicionado y calefacción central eficiente
                    en energía Lavadora y secadora apiladas incluidas Amplios armarios para tu guardarropa de estilo
                    playero chic
                </li>
                <li>COCINA</li>
                <li>Gabinetes europeos importados con accesorios premium Paquete de electrodomésticos Bosch con
                    refrigerador, horno, cocina, microondas y lavavajillas Encimeras y salpicaderos de piedra premium
                    para la experiencia culinaria definitiva Fregadero de acero inoxidable contemporáneo montado debajo
                    del mostrador Grifo elegante con mango de rociado integrado
                </li>
                <li>BAÑO PRINCIPAL</li>
                <li>Gabinetes europeos importados con herrajes premium y tiradores de cajones Encimeras y salpicaderos
                    de piedra premium Lavabos de porcelana rectangular con elegantes grifos dobles (en algunas
                    residencias) Suelos y paredes de porcelana con acabado personalizado en áreas húmedas Cabinas de
        ...
        amenidades: lang === "en" ? <>
            <ul>
                ...
                <li>State-of-the-art fully equipped fitness center with Technogym and views of the resort-style pool
                </li>
            ...
            <ul>
                ...
                <li>Edificio inteligente con tecnología avanzada y acceso a internet de fibra óptica de alta velocidad
                </li>
