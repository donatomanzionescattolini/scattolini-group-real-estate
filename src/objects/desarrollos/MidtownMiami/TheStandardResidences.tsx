...
TheStandardResidences.caracteristicas = {
    ...
    residencias: (
        <>
            <ul>
                <li>Los acabados instalados a la medida, diseÃ±ados por Urban Robot, elevan la experiencia humana y
                    brindan un sentido de pertenencia
                </li>
                <li>Los elegantes planos de planta abiertos y los techos de nueve pies (2.74 m) de altura invitan el
                    ingreso de la luz natural a travÃ©s de las puertas corredizas de vidrio enteras
                </li>
                <li>Las cocinas contemporÃ¡neas abiertas con electrodomÃ©sticos de primera lÃ­nea son elegantes y
                    funcionales
                </li>
                <li>El piso de cerÃ¡mica de primera calidad inspirado en madera ofrece una sofisticaciÃ³n atemporal</li>
                <li>Los baÃ±os a la medida se destacan por envidiables tocadores dobles y ducha con dos rociadores; todo
                    acentuado por elegantes accesorios en tonos de bronce
                </li>
                <li>Lavadora y secadora de alta eficiencia</li>
                <li>Las terrazas privadas al aire libre en ciertas residencias se conjugan a la perfecciÃ³n con la
                    energÃ­a vibrante de Midtown Miami
                </li>
            </ul>
        </>
    ),
