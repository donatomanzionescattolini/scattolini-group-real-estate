...
export default function WPompanoBeach(lang: "en" | "es" = "es") {
  ...
  WPompanoBeachObject.numberOfRooms = lang === "en" ? "2 to 4" : "2 a 4";
  ...
  WPompanoBeachObject.caracteristicas =
    lang === "en"
      ? {
          edificio: (
            <>
          ...
          residencias: (
            <>
              <ul>
                ...
                <li>
                  Breathtaking ocean and Intracoastal views, visible from all
                  residences
                </li>
                <li>Spacious private outdoor balconies up to 8.5' deep</li>
                <li>
                  Imported Italian kitchen cabinetry and natural stone
                  countertops
                </li>
                <li>
                  Custom-designed master bathroom by Meyer Davis featuring
                  soaking tub, Kohler toilets and fixtures
                </li>
                <li>
                  Powder room, living room, laundry and pantry available in each
                  residence
                </li>
                <li>
                  Wolf/Sub-Zero kitchen appliance package including: 30"
                  refrigerator, 24" freezer, 18" wine refrigerator, 36" gas
                  range, 30" oven, 30" speed oven, 30" coffee preparation
                  system, 24" dishwasher
                </li>
          ...
          amenidades: (
            <ul>
              ...
              <li>
                The Living Room: a social hub and gathering space with cultural
                events, live music, a refined speakeasy bar, culinary tastings
                and more.
              </li>
              <li>
                60,000 square foot WET® Pool Deck with resort-style pool,
                jacuzzi, private cabanas, pickleball and paddle courts
              </li>
              <li>WET® Pool Deck Bar & Restaurant</li>
              <li>FIT® Fitness Center and Yoga Studio</li>
              <li>
                6,800 square foot AWAY® Spa featuring dedicated suites for
                customized massages and wellness treatments, cold plunge,
                jacuzzi, sauna and steam rooms, and nail services
              </li>
              <li>
              ...
              <li>
                12,000 square foot outdoor pool deck with dedicated spa, private
                cabanas and chef's grilling station
              </li>
              <li>
                State-of-the-art fitness center with sauna and steam rooms
              </li>
      ...
      : {
          ...
          residencias: (
            <>
              <ul>
                ...
                <li>
                  Impresionantes vistas del océano y del Canal Intracostero,
                  visibles desde todas las residencias
                </li>
                <li>
                  Balcones amplios y privados al aire libre de hasta 8.5' de
                  profundidad
                </li>
                <li>
                  Gabinetes de cocina italianos importados y encimeras de piedra
                  natural
                </li>
                <li>
                  Baño principal diseñado a medida por Meyer Davis equipado con
                  bañera, inodoros Kohler y accesorios
                </li>
                <li>
                  Tocador, sala de estar, lavandería y despensa disponibles en
                  cada residencia
                </li>
                <li>
                  Paquete de electrodomésticos de cocina Wolf/Sub-Zero que
                  incluye: refrigerador de 30", congelador de 24", refrigerador
                  de vino de 18", estufa de gas de 36", horno de 30", horno de
                  30", horno de velocidad de 30", sistema de preparación de café
                  de 30", lavavajillas de 24"
                </li>
          ...
          amenidades: (
            <ul>
              ...
              <li>
                The Living Room: un centro social y espacio de reunión con
                eventos culturales, música en vivo, un refinado bar clandestino,
                degustaciones culinarias y más.
              </li>
              <li>
                Terraza de la piscina WET® de 60,000 pies cuadrados con piscina
                estilo centro turístico, jacuzzi, cabañas privadas, canchas de
                pickleball y pádel
              </li>
              <li>Bar y restaurante WET® Pool Deck</li>
              <li>Gimnasio y estudio de yoga FIT®</li>
              <li>
                AWAY® Spa de 6,800 pies cuadrados con suites dedicadas a masajes
                personalizados y tratamientos de bienestar, inmersión fría,
                jacuzzi, sauna y baños de vapor, y servicios de uñas
              </li>
              <li>
                Sala de juegos con carreras de F1 y simulador multideporte de
                clase mundial
              </li>
              <br />
              <dl>
              ...
              <li>
                Terraza de la piscina al aire libre de 12,000 pies cuadrados con
                spa dedicado, cabañas privadas y estación de parrillas del chef
              </li>
  ...
  WPompanoBeachObject.introduccion =
    lang === "en"
      ? [
      ...
      : [
          "Nos complace compartir una oportunidad excepcional: W Pompano Beach Hotel & Residences, la nueva evolución de la icónica marca W. Este refinado destino de lujo combina perfectamente el encanto de una escapada frente al mar con la energía de un vibrante centro social, ubicado en una de las playas más hermosas de Florida.",
